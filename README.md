...
Helps manage state a lot easier as our app begins to scale and state becomes harder to manage
...
store: This stores the whole state of the app in an immutable object tree
